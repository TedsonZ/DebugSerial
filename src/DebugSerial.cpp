...
void initializeSerial1ReceptionTask(size_t queueSize, size_t bufferSize, TaskHandle_t* outHandle)
{
    ...
    xTaskCreate(serial1ReceptionTask, "Serial1ReceptionTask", 6096, NULL, 1, &tempHandle);
